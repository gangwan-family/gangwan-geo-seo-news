...
<div class="container page-shell">
  ...
  <section class="page-intro">
    <p class="page-eyebrow">Industry brief</p>
    <h1>GEO-SEO News</h1>
    <p class="page-summary">按日期和来源整理 GEO、SEO、AI Search 相关文章，适合持续浏览和回看。</p>
    <div class="page-stats">
      <span>{{ sorted_posts | size }} 篇文章</span>
      <span>{{ grouped_dates | size }} 个日期目录</span>
      <span>{{ grouped_sources | size }} 个来源</span>
    </div>
  </section>
  ...
  <section class="filter-panel">
    ...
    <p class="filter-summary">筛选当前索引列表；文章详情页保留原始正文与原文链接。</p>
  </section>
