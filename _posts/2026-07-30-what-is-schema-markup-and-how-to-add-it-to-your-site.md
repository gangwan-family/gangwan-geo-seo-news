---
layout: post
title: "What is schema markup? And how to add it to your site"
date: 2026-07-30T10:21:00+00:00
source: "Semrush Blog"
generated_from: "GEO-SEO News/Semrush Blog/2026-07-30/What is schema markup And how to add it to your site.md"
original_url: "https://www.semrush.com/blog/schema-markup/"
categories:
  - "technical-seo"
---
...
Schema markup (a type of structured data) is code you add to your website to help search engines, and potentially AI systems, understand your content better. Schema markup is important for search engine optimization ( SEO ) because it can make your content eligible for rich results.
...
- Enhanced click-through rates (CTRs) : Rich results may see higher CTRs compared to standard blue links given users can preview key information directly in search results to better understand if it meets their search intent
...
No, schema markup is not a direct Google ranking factor. Google has stated that structured data doesn't influence how a page ranks in search results.
...
You do not need to add schema markup to be visible in AI responses. Google says there’s “no special schema.org structured data that you need to add” to appear in its AI features like AI Overviews and AI Mode. But adding schema markup is an SEO best practice . So, it’s beneficial to add proper schema markup to your content where relevant anyway.
...
Organization schema can also influence how your organization’s details appear in a knowledge panel in Google search results (if your business has a knowledge panel). For merchants, this can include details like returns policies and contact information.
...
Here’s an example of local business schema markup for a restaurant:
...
Generate your schema markup manually, with an AI tool, with a plugin if you’re using WordPress, or with Google’s Structured Data Markup Helper .

##### How to generate schema markup manually

Generating your schema markup by hand gives you the most control over what’s included, but it does require a good understanding of what valid schema markup looks like. You add a <script type="application/ld+json"> block to your page's <head> (or <body>) with the properties for your schema type, using schema.org 's vocabulary as your reference.
...
For example, we asked ChatGPT to generate JSON-LD schema for our post about the Google 3 Pack .
...
Use Google Search Console ’s URL inspection tool to check for schema markup issues on individual live URLs.
...
Use Semrush’s Site Audit tool to find and fix schema-related issues at scale.
...
If any errors show up, regenerate the markup for those pages (by hand, with an AI tool, or your plugin), then validate it again with the Rich Results Test .
...
[Read original](https://www.semrush.com/blog/schema-markup/)
