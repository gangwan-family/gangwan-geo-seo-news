---
layout: post
title: "Google Faces Class Action Over Books Used To Train Gemini via @sejournal, @MattGSouthern"
date: 2026-07-17T19:51:57+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-07-17/Google Faces Class Action Over Books Used To Train Gemini via @sejournal, @MattGSouthern.md"
original_url: "https://www.searchenginejournal.com/google-faces-class-action-over-books-used-to-train-gemini/582708/"
...
- URL: https://www.searchenginejournal.com/google-faces-class-action-over-books-used-to-train-gemini/582708/
- Author: Matt G. Southern
- Categories: Generative AI, News

## RSS 摘要

Publishers allege works supplied to Google Books, Play Books and Scholar were used to train Gemini without permission. No court has ruled on the claims. The post Google Faces Class Action Over Books Used To Train Gemini appeared first on Search Engine Journal .

## 原文正文

Google Faces Class Action Over Books Used To Train Gemini Skip to content
...
- Publishers and novelist Scott Turow are suing Google over books used to train Gemini.

- The complaint says the works were supplied for search and sales, not for AI training.

- Blocking AI crawlers would not have covered either route the complaint describes.
...
[Read original](https://www.searchenginejournal.com/google-faces-class-action-over-books-used-to-train-gemini/582708/)
