...
generated_from: "GEO-SEO News/OpenAI News/2026-07-31/Disrupting a Criminal Scam Operation.md"
original_url: "https://openai.com/index/disrupting-malicious-uses-of-ai-criminal-scam-operation"
categories:
  - "_src_openai-news"
---
...
As we’ve highlighted in ⁠ (opens in a new window) previous ⁠ (opens in a new window) reports ⁠ (opens in a new window) , the scammers followed a common pattern in their interactions with targets, which we think of as the ping (outreach), the zing (generate emotion), and the sting (extract money).
...
[Read original](https://openai.com/index/disrupting-malicious-uses-of-ai-criminal-scam-operation)
