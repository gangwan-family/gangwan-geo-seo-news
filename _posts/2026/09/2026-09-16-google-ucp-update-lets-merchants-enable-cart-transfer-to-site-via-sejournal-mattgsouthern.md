---
layout: post
title: "Google UCP Update Lets Merchants Enable Cart Transfer To Site via @sejournal, @MattGSouthern"
date: 2026-09-16T20:35:52+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-09-16/Google UCP Update Lets Merchants Enable Cart Transfer To Site via @sejournal, @MattGSouthern.md"
original_url: "https://www.searchenginejournal.com/google-ucp-update-lets-merchants-enable-cart-transfer-to-site/589713/"
...
# Google UCP Update Lets Merchants Enable Cart Transfer To Site via @sejournal, @MattGSouthern
...
Google is rolling out cart transfer and checkout testing in the Merchant Center UCP hub, plus a YouTube ads beta and wider AI insights. The post Google UCP Update Lets Merchants Enable Cart Transfer To Site appeared first on Search Engine Journal .

## 原文正文

Google UCP Update Lets Merchants Enable Cart Transfer To Site Skip to content
...
- Google is rolling out cart transfer and checkout testing in its UCP hub.

- Cart transfer has a shorter validation path that skips full product feed setup.

- The transfer path keeps the final checkout on the merchant's own site.

Google is rolling out cart transfer and checkout testing in the Merchant Center UCP hub, plus a YouTube ads beta and wider AI insights.

Google is rolling out cart transfer and expanded checkout testing in the Merchant Center hub for the Universal Commerce Protocol (UCP).
...
Featured Image: WinWin artlab/Shutterstock

Category News Ecommerce
...
[Read original](https://www.searchenginejournal.com/google-ucp-update-lets-merchants-enable-cart-transfer-to-site/589713/)
