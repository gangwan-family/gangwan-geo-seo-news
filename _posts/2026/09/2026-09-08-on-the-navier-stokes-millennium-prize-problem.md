...
generated_from: "GEO-SEO News/OpenAI News/2026-09-08/On the Navier–Stokes Millennium Prize Problem.md"
...
Read the paper Link to Lean formalized proof
...
Read the Euler proof paper ⁠ (opens in a new window) · Link to Lean formalized proof ⁠ (opens in a new window)
...
[Read original](https://openai.com/index/navier-stokes-solution)
