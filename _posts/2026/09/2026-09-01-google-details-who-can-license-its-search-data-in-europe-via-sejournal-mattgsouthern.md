---
layout: post
title: "Google Details Who Can License Its Search Data In Europe via @sejournal, @MattGSouthern"
date: 2026-09-01T17:20:25+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-09-01/Google Details Who Can License Its Search Data In Europe via @sejournal, @MattGSouthern.md"
original_url: "https://www.searchenginejournal.com/google-details-who-can-license-its-search-data-in-europe/587995/"
...
# Google Details Who Can License Its Search Data In Europe via @sejournal, @MattGSouthern

- Source: Search Engine Journal
- Published: 2026-09-01
- URL: https://www.searchenginejournal.com/google-details-who-can-license-its-search-data-in-europe/587995/
- Author: Matt G. Southern
- Categories: International Search, News

## RSS 摘要

Google published eligibility rules, samples, and key dates for licensing ranking, query, click, and view data from EEA Search under the EU's Digital Markets Act. The post Google Details Who Can License Its Search Data In Europe appeared first on Search Engine Journal .

## 原文正文

Google Details Who Can License Its Search Data In Europe Skip to content
...
- Google updated its documentation for the European Search Dataset Licensing Program.

- Licensing agreements start going out in September, with data samples following in November.

- Applicants must clear user thresholds plus an operating history or investment test.

Google published eligibility rules, samples, and key dates for licensing ranking, query, click, and view data from EEA Search under the EU's Digital Markets Act
...
[Read original](https://www.searchenginejournal.com/google-details-who-can-license-its-search-data-in-europe/587995/)
