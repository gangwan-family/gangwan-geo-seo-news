---
layout: post
title: "Local Services Ads To Performance Max: What To Audit Before Migration via @sejournal, @hethr_campbell"
date: 2026-09-15T07:45:08+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-09-15/Local Services Ads To Performance Max What To Audit Before Migration via @sejournal, @hethr_campbell.md"
original_url: "https://www.searchenginejournal.com/local-services-ads-to-performance-max-what-to-audit-before-migration-recap/588906/"
...
# Local Services Ads To Performance Max: What To Audit Before Migration via @sejournal, @hethr_campbell

- Source: Search Engine Journal
- Published: 2026-09-15
- URL: https://www.searchenginejournal.com/local-services-ads-to-performance-max-what-to-audit-before-migration-recap/588906/
- Author: Heather Campbell
- Categories: PPC, Webinar

## RSS 摘要

CallRail’s Meagan McLoughlin explains what to audit before/after Local Services Ads migrate into Google Ads, from historical reports to tracking numbers and lead quality. The post Local Services Ads To Performance Max: What To Audit Before Migration appeared first on Search Engine Journal .

## 原文正文

Local Services Ads Move To PMax: What To Audit Before Migration Skip to content
...
## Local Services Ads To Performance Max: What To Audit Before Migration

- Export historical performance reports from the Local Services Ads interface before migration; they do not transfer into Google Ads.

- Verify the migrated campaign’s preferred tracking number and keep LSA attribution separate from Google Business Profile and website tracking.

- Review daily budget pacing and the campaign-level target CPA alongside lead quality, not just lead volume.

- Assign a migration owner for each client and clarify whether LSA management falls within the agency’s existing scope.

- Treat rollout dates and unconfirmed features as account-specific questions rather than assuming every advertiser has already migrated.

Prepare for the Local Services Ads move to Performance Max with CallRail’s checks for historical reports, campaign budgets, tracking numbers, and lead quality.
...
Search Engine Journal uses the information you provide to contact you about our relevant content and promotions. Search Engine Journal will share the information you provide with our partner, CallRail , who will use your information for similar purposes. You can unsubscribe from communications from Search Engine Journal at any time.
...
- Keep Google Business Profile and LSA numbers distinct. Reusing one number makes it harder to distinguish which source generated a call.

- Use a dedicated static number for the LSA campaign. Do not reuse a number from a dynamic website tracking pool.

- Review service-specific setups. If campaigns are split by service or vertical, consider whether separate tracking numbers are needed to preserve attribution.
...
#### Audit Your Local Services Ads Before The PMax Move

Watch On Demand

## 原文链接

[Read original](https://www.searchenginejournal.com/local-services-ads-to-performance-max-what-to-audit-before-migration-recap/588906/)
