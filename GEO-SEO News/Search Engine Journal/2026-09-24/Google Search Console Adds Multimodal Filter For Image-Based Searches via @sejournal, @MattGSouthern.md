---
title: "Google Search Console Adds Multimodal Filter For Image-Based Searches via @sejournal, @MattGSouthern"
source: "Search Engine Journal"
published: 2026-09-24T14:52:48+00:00
fetched_at: 2026-09-24T23:55:23.995738+00:00
url: "https://www.searchenginejournal.com/google-search-console-multimodal-filter/590781/"
guid: "https://www.searchenginejournal.com/google-search-console-multimodal-filter/590781/"
...
# Google Search Console Adds Multimodal Filter For Image-Based Searches via @sejournal, @MattGSouthern
...
Search Console’s new multimodal filter shows which pages receive traffic from image-based searches, without query data. The post Google Search Console Adds Multimodal Filter For Image-Based Searches appeared first on Search Engine Journal .

## 原文正文

Google Search Console Adds Multimodal Filter For Image-Based Searches Skip to content
...
- Google is rolling out a multimodal option under Search Console's Web search type.

- It covers searches that use an image, including Lens and Circle to Search.

- It shows which pages image-based searches reach, without query data.

Search Console is rolling out a multimodal filter for searches that use an image, including Lens and Circle to Search. Query data isn't available for it.

Google is adding a multimodal filter to Search Console’s Performance report, covering searches where someone used an image as part of the search.
...
[Read original](https://www.searchenginejournal.com/google-search-console-multimodal-filter/590781/)
