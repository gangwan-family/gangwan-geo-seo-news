---
title: "Google Gemini Passes 1B Monthly Users, 63% Now Use Voice via @sejournal, @MattGSouthern"
source: "Search Engine Journal"
published: 2026-08-13T01:00:07+00:00
fetched_at: 2026-08-13T22:08:47.953145+00:00
url: "https://www.searchenginejournal.com/google-gemini-passes-1b-monthly-users-63-now-use-voice/585624/"
guid: "https://www.searchenginejournal.com/google-gemini-passes-1b-monthly-users-63-now-use-voice/585624/"
...
# Google Gemini Passes 1B Monthly Users, 63% Now Use Voice via @sejournal, @MattGSouthern
...
Google says its Gemini app passed 1 billion monthly users and reports that 63% now use voice, alongside camera, uploads, and app automation data. The post Google Gemini Passes 1B Monthly Users, 63% Now Use Voice appeared first on Search Engine Journal .

## 原文正文

Google Gemini Passes 1B Monthly Users, 63% Now Use Voice Skip to content
...
## Google Gemini Passes 1B Monthly Users, 63% Now Use Voice

- Google says the Gemini app has passed 1 billion monthly users.

- Google's figures put voice, camera and file uploads at the center of that use.

- The same shift toward voice and camera shows up in Google's AI Mode data.

Google says the Gemini app reached 1 billion monthly users, with 63% talking directly to it, alongside new usage data on camera, files, and automation.

Google says the Gemini app has passed 1 billion monthly users , and published usage figures showing that 63% of them now use voice.
...
Gemini App User Growth, Based On Google’s Disclosures

Google’s disclosed audience figures rose from 400M+ in May 2025 to 1B+ in August 2026.
...
Source: Google and Alphabet disclosures. Dates show when each figure was published, not when each threshold was crossed. Values marked + are reported lower bounds. Google used ‘monthly active users’ through July 2026 and ‘monthly users’ in August 2026.
...
[Read original](https://www.searchenginejournal.com/google-gemini-passes-1b-monthly-users-63-now-use-voice/585624/)
