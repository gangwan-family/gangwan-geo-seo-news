---
layout: post
title: "Google Rankings Link Higher AI Scores To Lower Positions via @sejournal, @MattGSouthern"
date: 2026-07-28T18:06:52+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-07-28/Google Rankings Link Higher AI Scores To Lower Positions via @sejournal, @MattGSouthern.md"
original_url: "https://www.searchenginejournal.com/heavily-ai-flagged-pages-still-rank-across-googles-top-10/583983/"
...
# Google Rankings Link Higher AI Scores To Lower Positions via @sejournal, @MattGSouthern

- Source: Search Engine Journal
- Published: 2026-07-28
- URL: https://www.searchenginejournal.com/heavily-ai-flagged-pages-still-rank-across-googles-top-10/583983/
- Author: Matt G. Southern
- Categories: News, SEO

## RSS 摘要

Data ties higher AI detector scores to lower positions and to fewer pages in Google's index, though heavily flagged pages still rank in top 10. The post Google Rankings Link Higher AI Scores To Lower Positions appeared first on Search Engine Journal .

## 原文正文

Google Rankings Link Higher AI Scores To Lower Positions Skip to content
...
## Google Rankings Link Higher AI Scores To Lower Positions

- Pages scoring higher for AI text sat lower in Google's top 10, and fewer of them were found in the index.

- The differences are gradual, and heavily flagged pages turned up at every position in the top 10.

- A detector score on its own gives you little to act on, which pushes the work back to the older quality questions.

Data ties higher AI detector scores to lower positions and to fewer pages in Google's index, though heavily flagged pages still rank in top 10.

AI-heavy pages turn up at every spot in Google’s top 10. But pages the detector reads as mostly AI-written sit lower in those results than pages with little AI text, and fewer of them were found in the index at all, according to new data .
...
Higher AI Scores, Fewer Pages Found In The Index

Share of roughly 100,000 pages meeting at least one of Ahrefs’ three index signals, grouped by the estimated share of text flagged as AI-generated.
...
Source: Ahrefs , published July 27, 2026. Roughly 100,000 pages, one per domain. Results show Ahrefs’ index signals, not confirmed Google index status. Figures are a floor, not a true indexing rate. The gap between groups is the finding, not the levels.
...
[Read original](https://www.searchenginejournal.com/heavily-ai-flagged-pages-still-rank-across-googles-top-10/583983/)
