---
layout: post
title: "Google Adds Local Businesses To EEA Search Result Units via @sejournal, @MattGSouthern"
date: 2026-09-18T17:51:12+00:00
source: "Search Engine Journal"
source_slug: "search-engine-journal"
generated_from: "GEO-SEO News/Search Engine Journal/2026-09-18/Google Adds Local Businesses To EEA Search Result Units via @sejournal, @MattGSouthern.md"
original_url: "https://www.searchenginejournal.com/google-adds-local-businesses-to-eea-search-result-units/589955/"
...
# Google Adds Local Businesses To EEA Search Result Units via @sejournal, @MattGSouthern
...
Google updated its Search documentation to add local business queries to the two result units rolled out in the EEA for directories and direct providers. The post Google Adds Local Businesses To EEA Search Result Units appeared first on Search Engine Journal .

## 原文正文

Google Adds Local Businesses To EEA Search Result Units Skip to content
...
- Google added local business queries to its redesigned Search results in the EEA.

- Approved aggregators can compete to show local listings after sending Google a data feed.

- Local businesses can appear in a companion unit without sending Google extra data.

Google updated its Search documentation to add local business queries to the two result units rolled out in the EEA for directories and direct providers.

Google says the two result units it rolled out in the European Economic Area this month now support local business queries.
...
[Read original](https://www.searchenginejournal.com/google-adds-local-businesses-to-eea-search-result-units/589955/)
